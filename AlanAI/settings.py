...
OAUTH2_PROVIDER = {
    'ACCESS_TOKEN_EXPIRE_SECONDS': 36000,  # Exemplo de configuração para expiração do token
    'REFRESH_TOKEN_EXPIRE_SECONDS': 1209600,  # Exemplo de configuração para expiração do refresh token
}
